		...
		<div class="container">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					...
					<li role="presentation"><a href="https://shop118097125.taobao.com">淘宝店铺：翰飞网络科技</a></li>
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<label class="radio-inline">
							<a target="_blank" href="//jq.qq.com/?_wv=1027&k=5ag8UPL"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="微擎模块盗版团购群" title="微擎模块盗版团购群"></a>
						</label>
...
function tpl_install_finish() {
	...
	<div class="alert alert-success">
		恭喜您!已成功安装“微擎”系统，您现在可以: <a target="_blank" class="btn btn-success" href="./web/index.php">访问网站首页</a>
	</div>
